...
def send_fraud_alert_email(raw_transaction_data, user_email):
     ...
     **Safety Tips**:
        - Avoid sharing sensitive information like passwords or OTPs with anyone.
        - Use secure and private networks for online transactions.
        - Regularly monitor your bank statements and report unauthorized transactions immediately.

        For assistance, please contact our **Cybersecurity Team** at: **+1-800-123-4567**.

        Stay safe,  
        Your Bank's Fraud Detection Team
        """
